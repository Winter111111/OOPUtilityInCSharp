...
namespace OOPUtilityInCSharp.AbstractClassInCSharp
{
	...
	internal abstract class Fruit
	{
		...
		// non-abstract method
		internal void FruitTaste() => Console.WriteLine("Fruits have taste");
	}
	...
	internal class WaterMelon : Fruit
	{
		...
		internal override void FruitColor() => Console.WriteLine("WaterMelon has {0} color", Color);
	}
	// inheriting from abstract class
	...
	internal class Mango : Fruit
	{
		...
		internal override void FruitColor() => Console.WriteLine("Mango has {0} color", Color);
	}
}
